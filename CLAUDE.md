...
- [`docs/animal-heroes.md`](docs/animal-heroes.md) — **históricos que son ANIMALES** (POV animal, "todo es un `Anima` con mente"): El Perro de Oberkassel, Togo, Hachikō, Cher Ami (autorados) + candidatos (Balto, Laika, Clever Hans, Koko, Jumbo…). Arco agridulce→reivindicación; van en Veterinaria/Cría/Mente.
