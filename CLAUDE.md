...
- [`docs/forge-simulation.md`](docs/forge-simulation.md) — **la Mecánica (Mesocosmos) + la Forja (Microcosmos)**: la 3ª área Meso es la **Mecánica** (reparar/mejorar máquinas de todas las áreas + vehículos/drones/avatares/teleportadores mecánica+magia); la **forja** de bronce (metales, históricos El Primer Herrero/Ötzi/Sargón, receta con typing) se mueve al **Microcosmos**. Reencuadre 2026-07-30.
