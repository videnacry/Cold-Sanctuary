...
| Cocina (simulación) | `Assets/Scripts/Kitchen/` | Paso A: `DirtArea` (genera suciedad real + umbral → misión), `DirtSpot` (mancha-objeto), `Cleaner` (limpia mancha a mancha). Ver `docs/kitchen-simulation.md` |
